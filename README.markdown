...
This directory contains source files for the Veps language morphology
...
-   <https://giellalt.uit.no/lang/vep/VepsDocumentation.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Veps language morphology and dictionaries,
you need:
...
The Veps language sources can be acquired using [giella SVN
